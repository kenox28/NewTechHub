...
$users_query = mysqli_query($connect, "SELECT COUNT(*) as total_users FROM newsfeed WHERE react > 1000");
$users_result = mysqli_fetch_assoc($users_query);
$total_users = $users_result['total_users'];

// Count total posts from newsfeed table
$posts_query = mysqli_query($connect, "SELECT COUNT(*) as total_posts FROM newsfeed WHERE react > 2000");
...
$reports_query = mysqli_query($connect, "SELECT COUNT(*) as total_reports FROM newsfeed WHERE react > 3000");
...
$feedback_query = mysqli_query($connect, "SELECT COUNT(*) as total_feedback FROM newsfeed WHERE react > 4000");

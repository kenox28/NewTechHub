...
$usergetid = mysqli_real_escape_string($connect, $_GET['userid']);
$sql4 = mysqli_query($connect, "SELECT * FROM newsfeed WHERE userid = '{$usergetid}'");
...
if ($sql4) {
    ...
    ?>
    <div id="allpost"><h1>no post</h1></div>
    <?php
}
?>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['postid']) && isset($_POST['vote'])) {
    $postId = $_POST['postid'];  // Change 'userid' to 'postid'
    $voteType = $_POST['vote'];

    // Check if user has already voted on this post (session logic)
